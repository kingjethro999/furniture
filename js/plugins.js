    ...
    var n = {
        init: function(e, i) {
            ...
            o("#" + t.options.gallery + " a").click(function(e) {
                ...
                e.preventDefault(),
                o(this).data("zoom-image") ? t.zoomImagePre = o(this).data("zoom-image") : t.zoomImagePre = o(this).data("image"),
        ...
        startZoom: function() {
            ...
            e.zoomTint = o("<div class='zoomTint' style='" + e.tintStyle + "'></div>"),
            e.zoomLens.wrap(e.tintContainer),
            e.zoomTintcss = e.zoomLens.after(e.zoomTint),
            e.zoomTintImage = o('<img style="position: absolute; left: 0px; top: 0px; max-width: none; width: ' + e.nzWidth + "px; height: " + e.nzHeight + 'px;" src="' + e.imageSrc + '">').appendTo(e.zoomLens).click(function() {
                e.$elem.trigger("click")
            }))),
            ...
            e.$elem.bind("mousemove", function(o) {
                ...
                (e.lastX !== o.clientX || e.lastY !== o.clientY) && (e.setPosition(o),
                e.currentLoc = o),
                e.lastX = o.clientX,
                e.lastY = o.clientY
            }),
            ...
            e.options.scrollZoom && e.zoomContainer.add(e.$elem).bind("mousewheel DOMMouseScroll MozMousePixelScroll", function(i) {
                ...
                i.stopPropagation(),
                i.preventDefault(),
                t / 120 > 0 ? e.currentZoomLevel >= e.minZoomLevel && e.changeZoomLevel(e.currentZoomLevel - e.options.scrollZoomIncrement) : e.options.maxZoomLevel ? e.currentZoomLevel <= e.options.maxZoomLevel && e.changeZoomLevel(parseFloat(e.currentZoomLevel) + e.options.scrollZoomIncrement) : e.changeZoomLevel(parseFloat(e.currentZoomLevel) + e.options.scrollZoomIncrement),
                !1
            })
        },
        setElements: function(o) {
            var e = this;
            return e.options.zoomEnabled ? ("show" == o && e.isWindowSet && ("inner" == e.options.zoomType && e.showHideWindow("show"),
            ...
            void ("hide" == o && ("window" == e.options.zoomType && e.showHideWindow("hide"),
        ...
        setPosition: function(o) {
            ...
            e.mouseLeft < 0 || e.mouseTop < 0 || e.mouseLeft > e.nzWidth || e.mouseTop > e.nzHeight ? void e.setElements("hide") : (e.options.showLens && (e.lensLeftPos = String(Math.floor(e.mouseLeft - e.zoomLens.width() / 2)),
        ...
        setWindowPostition: function(e) {
            ...
            "window" == i.options.zoomType && (i.largeHeight < i.options.zoomWindowHeight && (i.windowTopPos = 0),
            ...
            i.loop || (i.loop = setInterval(function() {
                ...
                i.scrollingLock = !1,
                i.loop = !1) : Math.round(Math.abs(i.xp - i.windowLeftPos) + Math.abs(i.yp - i.windowTopPos)) < 1 ? (clearInterval(i.loop),
                i.zoomWindow.css({
                    backgroundPosition: i.windowLeftPos + "px " + i.windowTopPos + "px"
                }),
        ...
        doneCallback: function() {
            ...
            "window" == o.options.zoomType && (o.nzHeight < o.options.zoomWindowWidth / o.widthRatio ? lensHeight = o.nzHeight : lensHeight = String(o.options.zoomWindowHeight / o.heightRatio),
            o.options.zoomWindowWidth < o.options.zoomWindowWidth ? lensWidth = o.nzWidth : lensWidth = o.options.zoomWindowWidth / o.widthRatio,
            o.zoomLens && (o.zoomLens.css("width", lensWidth),
        ...
        getGalleryList: function() {
            ...
            e.options.gallery ? o("#" + e.options.gallery + " a").each(function() {
                var i = "";
...
!function(t) {
    ...
    var r = function(i, o) {
        ...
        s.init = function() {
            ...
            e(o["in"].effect) ? s.$current.css("visibility", "hidden") : n(o.out.effect) && s.$current.css("visibility", "visible"),
            s.setOptions(o),
            s.timeoutRun = null,
            setTimeout(function() {
        ...
        s.triggerEvent = function(e) {
            var n = t.Event(e + ".tlt");
            return r.trigger(n, s),
            n
        }
        ,
        s["in"] = function(i, o) {
            i = i || 0;
            var c, u = s.$texts.find(":nth-child(" + ((i || 0) + 1) + ")"), f = t.extend(!0, {}, s.options, u.length ? a(u[0]) : {});
            u.addClass("current"),
            ...
            c = s.$current.find('[class^="' + s.options.type + '"]').css("display", "inline-block"),
            ...
            setTimeout(function() {
                ...
                function e(t) {
                    s["in"](t, function() {
                        ...
                        t += 1,
                        !s.options.loop && t >= n ? (s.options.callback && s.options.callback(),
                        s.triggerEvent("end")) : (t %= n,
